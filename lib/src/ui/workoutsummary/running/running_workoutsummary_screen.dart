  ...
  Widget build(BuildContext context) {
    return BaseView(
        ...
        child: ExpandableBottomSheet(
          ...
          persistentHeader: ContainerWithActionAndLeading(
              leading: Container(
              ...
              height: 180,
              child: RoundedContainer.withCustomBorderRadius(
                height: 181,
          ...
          expandableContent: showModalBootomSheet(),
        ));
  }

  Widget showModalBootomSheet() {
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        buildColorCircleTextValue3Pair(
                            "Steps",
                            con.selected.steps.toStringAsFixed(0) + " steps",
                            Color(0xCCa83434)),
                        buildColorCircleTextValue3Pair(
                            "Altitude",
                        ...
                        Align(
                            ...
                            child: Container(
                                ...
                                child: Slider(
                                  ...
                                  min: 0,
                                  max: ((widget.workout.data as Running)
                                              .snapShots
                                              .length -
                                          1)
                                      .toDouble(),
                                  ...
                                  onChangeEnd: (value) {
                                    setState(() {
                                      containerColor =
                                          containerColor.withOpacity(1);
                                    });
                                  },
                                  onChanged: (value) {
                                    setState(() {
                                      con.changePosition(
                                          widget.workout, value.toInt());
                                    });
                                  },
                                ))),
                      ]),
