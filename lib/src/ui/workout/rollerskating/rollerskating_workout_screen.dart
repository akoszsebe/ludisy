...
class RollerSkatingWorkoutScreen extends StatefulWidget {
  RollerSkatingWorkoutScreen({Key key}) : super(key: key);
  @override
  _RollerSkatingWorkoutScreenState createState() =>
      _RollerSkatingWorkoutScreenState();
}

class _RollerSkatingWorkoutScreenState extends BaseScreenState<
    RollerSkatingWorkoutScreen, RollerSkatingWorkoutController> {
  _RollerSkatingWorkoutScreenState() : super();
